...
namespace WP\PastPerfect\Endpoints\V2;

use WP\PastPerfect\Record;
...
class Endpoint {
	...
	public function get_record( \WP_REST_Request $request ) {
		...
		if ( ! isset( $params['identifier'] ) ) {
			return new \WP_Error( 'wppp_no_identifier', 'No identifier provided.', array( 'status' => 404 ) );
		}
		...
		if ( ! $record_id ) {
			return new \WP_Error( 'wppp_record_not_found', 'No record found matching that identifier.', array( 'status' => 404 ) );
		}
